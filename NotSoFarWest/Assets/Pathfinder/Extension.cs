...
namespace Pathfinder.Extensions
{
    public static class Extension
    {
        ...
        public static TResult[] Select2<TSource, TResult>(this NativeList<TSource> origin, Func<TSource, TResult> func)
         where TSource : struct
        {
            var t = new List<TResult>();
            for (int i = 0; i < origin.Length; i++)
            {
                t.Add(func(origin.ElementAt(i)));
            }
            return t.ToArray();
        }
